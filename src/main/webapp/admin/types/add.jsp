  ...
  <div class="x-body">
    <form class="layui-form" method="post" action="/types/save?id=${type.id}">
      ...
      <c:choose>
        ...
        <c:when test="${ empty parentTypeList}">
          <div class="layui-form-item">
            <label  class="layui-form-label">
              <span class="x-red">*</span>类型名称
            </label>
            <div class="layui-input-inline">
              <input type="hidden" value="0" name="parentCode">
              <input type="text" value="" name="typeName"  class="layui-input">
            </div>
          </div>
        </c:when>
      ...
      <div class="layui-col-md6">
        <div class="layui-card">
          ...
          <div class="layui-col-md10">
            <textarea name="typeMemo"  placeholder="" class="layui-textarea"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" name="createTime" value=""  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})" class="layui-input">
        </div>
