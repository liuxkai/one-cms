...
<html>
    ...
    <form class="layui-form" method="post" action="/types/save?id=${type.id}">
      ...
      <c:choose>
        ...
        <c:otherwise>
            ...
            <div class="layui-inline">
              ...
              <div class="layui-input-inline">
                <select id="typeName" name="typeName">
                  ...
                  <c:forEach items="${parentType}" var="parent">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="text" value="${type.typeName}" name="" class="layui-input">
            </div>
          </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" value="${type.typeMemo}" name="" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
  ...
  <script>
    $(function () {
        $("#typeName option[value=${type.parentCode}]").prop("selected",true);
        $("#add").click(function () {
            $("form").submit();
