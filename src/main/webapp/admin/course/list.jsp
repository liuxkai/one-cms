...
<html>
  ...
  <div class="x-body">
    <div class="layui-row">
      <form class="layui-form layui-col-md12 x-so" action="/course/pageList" method="get">
        ...
        <input type="text" name="userName" value="${users.userName}"  placeholder="请输入课程名称" autocomplete="off" class="layui-input">
    ...
    <table class="layui-table">
      ...
      <tbody>
      <c:forEach var="course" items="${pager.list}" varStatus="courseStatus">
      <tr>
        <td>
