    ...
    <table class="layui-table">
      ...
      <tr>
        ...
        <td class="td-manage">
          ...
          <button class="layui-btn layui-btn-warm layui-btn-xs"  onclick="x_admin_show('查看','${ctx}/users/input?id=${user.id}')" ><i class="layui-icon">&#xe642;</i>查看</button>
